...
if("FALSE" STREQUAL "TRUE")
  set(ur_gazebo_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-ur-gazebo-1.2.5)
  set(ur_gazebo_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-ur-gazebo-1.2.5/obj-x86_64-linux-gnu/devel)
  ...
  set(ur_gazebo_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
